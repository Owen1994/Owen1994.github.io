    ...
    export default {
        ...
        methods: {
            ...
            getData(pageNumer) {
                ...
                this.$http.jsonp('https://api.douban.com/v2/movie/top250?start='+this.pageNum*20, {method: 'GET'}).then(function (response) {
            ...
            sendAjax() {
                this.$http.jsonp('https://api.douban.com/v2/movie/top250?start='+this.pageNum*20, {
                    method: 'GET',
                    before(request) {
